class ToscBeamEffect extends LinkBeamEffect;//xEmitter;
...
/*	if ( Level.NetMode == NM_DedicatedServer )
    ...
    {*/
	SetLocation( Instigator.GetBoneCoords(Instigator.HeadBone).Origin + Normal(EndEffect - Instigator.Location) * 25.0 );
