class DrakkLightArmA extends DrakkLightGib;
...
defaultproperties
{
     ...
     StaticMesh=StaticMesh'tk_U2Creatures.DrakkLightGibs.DrakkLightArmA'
     DrawScale=0.300000
     PrePivot=(Z=6.000000)
     Skins(0)=Shader'tk_U2Creatures.Drakk.DrakkLight_AFX'
     Skins(1)=Shader'tk_U2Creatures.Drakk.DrakkLight_AFX'
