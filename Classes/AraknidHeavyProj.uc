class AraknidHeavyProj extends Projectile;
...
auto state Flying
{
    ...
    {
        local AraknidHeavyProj Glob;

        Glob = AraknidHeavyProj(Other);
...
function BlowUp(Vector HitLocation)
{
    ...
    Spawn(Class'AraknidLight', Owner,, Location+GoopVolume*(CollisionHeight+4.0)*SurfaceNormal);
    PlaySound(Sound'tk_U2Creatures.AraknidHeavyA_Misc.SpiderBabySpawn', SLOT_MISC);
    }
...
{
    local int g;
    local AraknidHeavyProj NewGlob;
    local Vector VNorm;
...
defaultproperties
{
     ...
     DrawScale=2.800000
     Skins(0)=Shader'tk_U2Creatures.Assets.Blood_ArachnidFX_01'
     AmbientGlow=80
     SoundVolume=255
