...
// U2SkaarjProjectile.
//=============================================================================
class U2SkaarjProjectileMedium extends Projectile;


var FX_U2CSkaarjBoltMedium SkaarjBoltEffect;
//viewshake
...
simulated function PostBeginPlay()
{
    ...
    {
        SkaarjBoltEffect = Spawn(class'FX_U2CSkaarjBoltMedium', self);
...
simulated function ProcessTouch (Actor Other, vector HitLocation)
{
    ...
    if (Other.IsA('U2SkaarjProjectileMedium')) return;
...
simulated function Explode(vector HitLocation,vector HitNormal)
{
    ...
    {
        Spawn(class'FX_U2CSkaarjBoltExplosionMedium',,, Location);//shockexplosioncore
        if ( !Level.bDropDetail && (Level.DetailMode != DM_Low) )
            Spawn(class'FX_U2CSkaarjBoltExplosionMedium',,, Location);
    }
...
defaultproperties
{
     ...
     ImpactSound=Sound'tk_U2Creatures.WeaponsA_skaarjglove.SG_MediumExplode'
     ...
     AmbientSound=Sound'tk_U2Creatures.WeaponsA_skaarjglove.SG_MediumAmbient'
     LifeSpan=10.000000
     Texture=None
     DrawScale=0.700000
