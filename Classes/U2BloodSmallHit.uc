...
// BloodSmallHit.
//=============================================================================
class U2BloodSmallHit extends BloodSpurt;
...
defaultproperties
{
     BloodDecalClass=Class'tk_U2Creatures.u2bloodsplatterred'
     Splats(0)=Texture'tk_U2Creatures.Blood.bloodA_tw256'
     Splats(1)=Texture'tk_U2Creatures.Blood.bloodB_tw256'
     Splats(2)=Texture'tk_U2Creatures.Blood.bloodD_tw128'
     ...
     mNumTileColumns=1
     mNumTileRows=1
     Skins(0)=Texture'tk_U2Creatures.Blood.bloodA_tw256'
     Style=STY_Masked
}
