...
// from the Satore Monster Pack
//=============================================================================
class MarineController extends Bot;
...
function Destroyed()
{
	...
	super(SCriptedController).Destroyed();
}
...
{
	super(ScriptedController).ReceiveProjectileWarning(proj);
}
